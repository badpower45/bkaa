...
async function fixFunction() {
    try {
        console.log('🔧 جاري تطبيق الـ fix...\n');
...
DECLARE
    ...
    v_draft RECORD;
BEGIN
    -- Get draft product - FIXED: Cast id to text for comparison
    ...
    -- Delete draft product - FIXED: Cast id to text for comparison
...
$$ LANGUAGE plpgsql;
        ...
        console.log('✅ تم تطبيق الـ fix بنجاح!');
        console.log('✅ دلوقتي ارجع للموقع وجرب النشر تاني');
        console.log('\n📌 الـ function اتعدلت في Supabase');
